...
// Énergie solaire achetés via package pré-configuré ou devis personnalisé ; non applicable à la sécurité
// ou la climatisation en V1. UC-09-001, scénario d'erreur E1 : un produit non éligible ne doit simplement
// pas afficher l'option de planification.
