      ...
      <AnimatePresence>
        {ouvert && (
          <motion.div
            ...
            className="fixed bottom-[92px] right-5 z-30 flex h-[28rem] w-[min(22rem,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-2xl border border-bordure bg-background shadow-2xl print:hidden"
          >
